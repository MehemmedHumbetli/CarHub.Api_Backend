...
public class UpdateCategory
{
    ...
    public sealed class Handler(IUnitOfWork unitOfWork, IMapper mapper) : IRequestHandler<CategoryCommand, Result<UpdateDto>>
    {
        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        private readonly IMapper _mapper = mapper;

        public async Task<Result<UpdateDto>> Handle(CategoryCommand request, CancellationToken cancellationToken)
        {
