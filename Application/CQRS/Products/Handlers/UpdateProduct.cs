...
{
    public record struct Command : IRequest<Result<UpdateProductDto>>
    {
    ...
    public sealed class Handler(IUnitOfWork unitOfWork, IMapper mapper) : IRequestHandler<Command, Result<UpdateProductDto>>
    {
        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        private readonly IMapper _mapper = mapper;

        public async Task<Result<UpdateProductDto>> Handle(Command request, CancellationToken cancellationToken)
        {
